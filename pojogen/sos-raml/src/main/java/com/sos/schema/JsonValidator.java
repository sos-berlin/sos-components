...
public class JsonValidator {
    ...
    private static final Map<String, String> CLASS_URI_MAPPING = Collections.unmodifiableMap(new HashMap<String, String>() {
...

        {
            ...
            put("com.sos.joc.model.joc.RunningLogFilter", "joc/runningLogFilter-schema.json");
            ...
            put("com.sos.joc.model.inventory.sync.RequestFilter", "inventory/sync/request-filter-schema.json");
            ...
            put("com.sos.joc.model.note.common.ModifyRequest", "note/common/request-modify-schema.json");
            put("com.sos.joc.model.note.AddPost", "note/addPost-schema.json");
            put("com.sos.joc.model.note.DisplayPreferencesRequest", "note/request-displayPreferences-schema.json");
            ...
            put("com.sos.joc.model.publish.RedeploySyncFilter", "publish/redeploySyncFilter-schema.json");
            ...
            put("com.sos.joc.model.log.JOCLogRequest", "logManagement/joc-log-request-schema.json");
