<tr><td>``agents``</td><td>required, array</td><td>Collection of Agents
    ...
    <tr><td style="padding-left:20px;">``agentAliases``</td><td>optional, array</td><td>Aliases of the ``agentName``</td><td></td><td></td></tr>
