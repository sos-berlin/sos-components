...
public class PeriodResolver {
    ...
    public PeriodResolver() {
        ...
        listOfPeriods = new ArrayList<String>();
    ...
    private void add(String start) {
        LOGGER.debug("Adding " + start);
        listOfPeriods.add(start);
    }
    ...
    public List<Long> getStartTimes(String d) throws ParseException {
        listOfStartTimes = new ArrayList<Long>();
        for (String period : listOfPeriods) {
            listOfStartTimes.add(getDate(d, period).getTime());
        }
        return listOfStartTimes;
    }
}
