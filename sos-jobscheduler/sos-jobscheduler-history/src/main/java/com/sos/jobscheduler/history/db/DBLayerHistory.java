...
public class DBLayerHistory {
    ...
    public DBItemJobSchedulerSettings getSchedulerSettings(SOSHibernateSession session) throws SOSHibernateException {
    ...
    public DBItemJobSchedulerSettings insertSchedulerSettings(SOSHibernateSession session, String eventId) throws SOSHibernateException {
    ...
    public DBItemJobSchedulerSettings updateSchedulerSettings(SOSHibernateSession session, DBItemJobSchedulerSettings item, Long eventId)
    ...
    public DBItemJobSchedulerOrderHistory getOrderHistory(SOSHibernateSession session, String schedulerId, String orderKey)
            throws SOSHibernateException {

        return getOrderHistory(session, schedulerId, orderKey, null);
    }

    public DBItemJobSchedulerOrderHistory getOrderHistory(SOSHibernateSession session, String schedulerId, String orderKey, String startEventId)
            throws SOSHibernateException {
    ...
    public DBItemJobSchedulerOrderStepHistory getOrderStepHistoryById(SOSHibernateSession session, Long id) throws SOSHibernateException {
    ...
    public DBItemJobSchedulerOrderStepHistory getOrderStepHistory(SOSHibernateSession session, String schedulerId, String orderKey)
            throws SOSHibernateException {
