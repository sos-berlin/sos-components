...
@Table(name = DBLayer.HISTORY_TABLE_AGENTS, uniqueConstraints = { @UniqueConstraint(columnNames = { "[EVENT_ID]", "[PATH]" }) })
...
public class DBItemAgentTest extends DBItemTest implements Serializable {
    ...
    public boolean equalsX(Object o) {
        if (o == null || !(o instanceof DBItemAgentTest)) {
            return false;
        }
        DBItemAgentTest item = (DBItemAgentTest) o;
