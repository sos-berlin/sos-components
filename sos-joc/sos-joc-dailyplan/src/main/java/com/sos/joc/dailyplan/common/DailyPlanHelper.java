...
public class DailyPlanHelper {
    ...
    // --------------------- START - Introduced with JOC-1980
    // Currently the following methods are used by ScheduleRuntimeImpl (Schedule Preview)
    // TODO - should be used by DailyPlanRunner
    ...
    public static Period resolveSingleDatePeriod(String date, Period period, List<String> nonWorkingDates,
            Set<String> workingDatesExtendedWithNonWorkingPrevNext) {
        Period p = new Period();
        if (LOGGER.isDebugEnabled()) {
