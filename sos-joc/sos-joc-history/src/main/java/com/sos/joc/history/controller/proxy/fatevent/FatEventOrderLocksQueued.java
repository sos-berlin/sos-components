...
public final class FatEventOrderLocksQueued extends AFatEventOrderLocks {

    public FatEventOrderLocksQueued(Long eventId, Date eventDatetime, String orderId, List<OrderLock> orderLocks, Position position) {
        super(eventId, eventDatetime, orderId, orderLocks, position);
    }

    @Override
    public HistoryEventType getType() {
        return HistoryEventType.OrderLocksQueued;
    }
