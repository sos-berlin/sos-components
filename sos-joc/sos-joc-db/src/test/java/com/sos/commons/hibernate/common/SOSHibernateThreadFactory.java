...
public class SOSHibernateThreadFactory extends SOSHibernateFactory {
    ...
    public SOSHibernateThreadFactory(Path config, int minPoolSize, int maxPoolSize) throws SOSHibernateConfigurationException {
        super(config);
        minPool = minPoolSize;
        maxPool = maxPoolSize;
    }
