...
@Entity
@Table(name = DBLayer.TABLE_DEP_CONFIGURATIONS, uniqueConstraints = { @UniqueConstraint(columnNames = { "[PATH]", "[VERSION]", "[OBJECT_TYPE]" }) })
@SequenceGenerator(name = DBLayer.TABLE_DEP_CONFIGURATIONS_SEQUENCE, sequenceName = DBLayer.TABLE_DEP_CONFIGURATIONS_SEQUENCE, allocationSize = 1)
public class DBItemDeployedConfiguration extends DBItem {

    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.AUTO, generator = DBLayer.TABLE_DEP_CONFIGURATIONS_SEQUENCE)
