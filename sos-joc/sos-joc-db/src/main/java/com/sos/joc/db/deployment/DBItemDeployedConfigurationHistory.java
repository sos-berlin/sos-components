...
@SequenceGenerator(name = DBLayer.TABLE_DEP_CONFIGURATION_HISTORY_SEQUENCE, sequenceName = DBLayer.TABLE_DEP_CONFIGURATION_HISTORY_SEQUENCE, allocationSize = 1)
