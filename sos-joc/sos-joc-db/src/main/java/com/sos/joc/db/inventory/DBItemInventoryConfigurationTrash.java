...
@SequenceGenerator(name = DBLayer.TABLE_INV_CONFIGURATION_TRASH_SEQUENCE, sequenceName = DBLayer.TABLE_INV_CONFIGURATION_TRASH_SEQUENCE, allocationSize = 1)
public class DBItemInventoryConfigurationTrash extends DBItem {

    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.AUTO, generator = DBLayer.TABLE_INV_CONFIGURATION_TRASH_SEQUENCE)
    @GenericGenerator(name = DBLayer.TABLE_INV_CONFIGURATION_TRASH_SEQUENCE)
