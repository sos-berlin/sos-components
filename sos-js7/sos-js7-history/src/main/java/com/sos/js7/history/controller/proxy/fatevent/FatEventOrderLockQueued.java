...
public final class FatEventOrderLockQueued extends AFatEventOrderLock {

    public FatEventOrderLockQueued(Long eventId, Date eventDatetime, String orderId, OrderLock orderLock, Position position) {
        super(eventId, eventDatetime, orderId, orderLock, position);
    }

    @Override
    public HistoryEventType getType() {
        return HistoryEventType.OrderLockQueued;
    }
