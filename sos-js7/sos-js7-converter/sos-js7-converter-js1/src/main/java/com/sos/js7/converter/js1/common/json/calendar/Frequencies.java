...
@JsonPropertyOrder({ "dates", "weekdays", "monthdays", "ultimos", "months", "holidays", "repetitions" })
public class Frequencies {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("dates", dates).append("weekdays", weekdays).append("monthdays", monthdays).append("ultimos", ultimos)
                .append("months", months).append("holidays", holidays).append("repetitions", repetitions).toString();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(months).append(holidays).append(weekdays).append(dates).append(monthdays).append(ultimos).append(
                repetitions).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(months, rhs.months).append(holidays, rhs.holidays).append(weekdays, rhs.weekdays).append(dates, rhs.dates)
                .append(monthdays, rhs.monthdays).append(ultimos, rhs.ultimos).append(repetitions, rhs.repetitions).isEquals();
    }
