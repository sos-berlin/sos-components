...
@JsonPropertyOrder({ "months", "from", "to", "weekdays", "monthdays", "ultimos" })
public class Months {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("months", months).append("from", from).append("to", to).append("weekdays", weekdays).append(
                "monthdays", monthdays).append("ultimos", ultimos).toString();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(months, rhs.months).append(weekdays, rhs.weekdays).append(from, rhs.from).append(monthdays, rhs.monthdays)
                .append(to, rhs.to).append(ultimos, rhs.ultimos).isEquals();
    }
