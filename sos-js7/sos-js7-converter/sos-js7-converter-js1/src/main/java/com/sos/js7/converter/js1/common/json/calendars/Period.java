...
@JsonPropertyOrder({ "singleStart", "begin", "end", "repeat", "absoluteRepeat", "whenHoliday" })
public class Period {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("singleStart", singleStart).append("begin", begin).append("end", end).append("repeat", repeat).append(
                "absoluteRepeat", absoluteRepeat).append("whenHoliday", whenHoliday).toString();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(singleStart).append(repeat).append(end).append(absoluteRepeat).append(begin).append(whenHoliday)
                .toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(singleStart, rhs.singleStart).append(repeat, rhs.repeat).append(end, rhs.end).append(absoluteRepeat,
                rhs.absoluteRepeat).append(begin, rhs.begin).append(whenHoliday, rhs.whenHoliday).isEquals();
    }
