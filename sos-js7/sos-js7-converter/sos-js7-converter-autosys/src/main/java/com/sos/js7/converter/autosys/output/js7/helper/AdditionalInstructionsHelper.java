...
public class AdditionalInstructionsHelper {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(AdditionalInstructionsHelper.class);

    private static final String DEFAULT_POST_CONSUME_BOARD_NAME = "OK";
    private static final String DEFAULT_POST_CONSUME_BOARD_LIFETIME = "$js7EpochMilli + 3 * 1000"; // 3 seconds
    private static final String DEFAULT_POST_CONSUME_BOARD_ORDER_TO_NOTICE_ID = "$js7OrderId";

    public static final Map<String, Board> POST_CONSUME_BOARDS = new HashMap<>();
    ...
    public static List<Instruction> consumeNoticesIfExists(AutosysAnalyzer analyzer, WorkflowResult wr, List<Instruction> tryInstructions) {
        ...
        String okNoticeName = DEFAULT_POST_CONSUME_BOARD_NAME;
        ...
        if (ok == null) {
            POST_CONSUME_BOARDS.put(okNoticeName, JS7ConverterHelper.createNoticeBoard(okNoticeName, DEFAULT_POST_CONSUME_BOARD_LIFETIME,
                    DEFAULT_POST_CONSUME_BOARD_ORDER_TO_NOTICE_ID));
        }
