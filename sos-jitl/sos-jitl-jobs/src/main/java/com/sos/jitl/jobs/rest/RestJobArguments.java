...
public class RestJobArguments extends JobArguments {
	...
	private final JobArgument<String> ClientId = new JobArgument<>("client_id", false);
	private final JobArgument<String> ClientSecret = new JobArgument<>("client_secret", false,
