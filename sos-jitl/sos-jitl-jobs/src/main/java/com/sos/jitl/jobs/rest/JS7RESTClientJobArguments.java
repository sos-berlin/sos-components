...
public class JS7RESTClientJobArguments extends JobArguments {
    ...
    private final JobArgument<String> keystoreKeyPassword = new JobArgument<>("js7.web.https.keystore.key-password", false);
    private final JobArgument<String> keystoreStorePassword = new JobArgument<>("js7.web.https.keystore.store-password", false);
    ...
    private final JobArgument<String> truststoreStorePassword = new JobArgument<>("js7.web.https.truststore.store-password", false);
    ...
    private final JobArgument<String> apiServerCSPassword = new JobArgument<>("js7.api-server.cs-password", false);
    ...
    private final JobArgument<String> apiServerPassword = new JobArgument<>("js7.api-server.password", false);
