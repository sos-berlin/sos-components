...
public class SOSCredentialStoreArguments extends ASOSArguments {
    ...
    public static final String ARG_NAME_MODULE = "credential_store_module";
    ...
    private SOSArgument<String> module = new SOSArgument<String>(ARG_NAME_MODULE, false, SOSKeePassDatabase.DEFAULT_MODULE.name());
    ...
    public SOSArgument<String> getModule() {
        return module;
    }
