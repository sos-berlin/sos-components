...
@Entity
@Table(name = HistoryDBItemConstants.TABLE_SCHEDULER_ORDER_STEP_HISTORY)
@SequenceGenerator(name = HistoryDBItemConstants.TABLE_SCHEDULER_ORDER_STEP_HISTORY_SEQUENCE, sequenceName = HistoryDBItemConstants.TABLE_SCHEDULER_ORDER_STEP_HISTORY_SEQUENCE, allocationSize = 1)
public class DBItemSchedulerOrderStepHistory implements Serializable {
    ...
    /** Primary key */
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO, generator = HistoryDBItemConstants.TABLE_SCHEDULER_ORDER_STEP_HISTORY_SEQUENCE)
