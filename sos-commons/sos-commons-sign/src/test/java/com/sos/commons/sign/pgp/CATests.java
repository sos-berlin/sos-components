...
public class CATests {
    ...
    @Test
    public void test01CreateRootCertificateCSRAndUserCertificate() throws NoSuchAlgorithmException, NoSuchProviderException, OperatorCreationException,
    CertificateException, IOException, CertException, InvalidKeyException, InvalidKeySpecException, SignatureException {
        ...
        LOGGER.info("************************************  CSR:  ***********************************************************");
        LOGGER.info("\n" + csrAsString);
        X509Certificate userCertificate = CAUtils.signCSR(userKeyPair.getPrivate(), csr, (X509Certificate)rootCertificate, "sp.sos");
