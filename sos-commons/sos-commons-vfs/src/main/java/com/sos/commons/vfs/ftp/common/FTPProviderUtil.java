...
public class FTPProviderUtil {
    ...
    // possible recursion
    public static List<ProviderFile> selectFiles(AFTPProvider provider, ProviderFileSelection selection, String directoryPath,
    ...
    private static int list(AFTPProvider provider, ProviderFileSelection selection, String directoryPath, List<ProviderFile> result, int counterAdded)
    ...
    private static int processListEntry(AFTPProvider provider, ProviderFileSelection selection, FTPFile resource, List<ProviderFile> result,
