...
public interface IProvider {
     ...
     * 
     * @throws SOSProviderConnectException if an error occurs during connection or authentication */
     ...
     * @throws SOSProviderException if an error occurs during the file selection process */
     ...
     * @throws SOSProviderException if an error occurs during the renaming process */
     ...
     * @throws SOSProviderException if an error occurs while checking for the file */
     ...
     * @throws SOSProviderException if an error occurs while rereading the file */
     ...
     * @throws SOSProviderException if an error occurs while retrieving the file content */
     ...
     * @throws SOSProviderException if an error occurs while writing the file */
     ...
     * @throws SOSProviderException if an error occurs while setting the file's last modified timestamp */
     ...
     * @throws SOSProviderException if an error occurs while retrieving the input stream */
     ...
     * @throws SOSProviderException if an error occurs while retrieving the output stream */
