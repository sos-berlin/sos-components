...
/** Only String operations should be used, without nio Path(see REGEX_ABSOLUTE_WINDOWS_OPENSSH_PATH) */
public class SOSPathUtils {
    ...
    /** Combined Windows Path RegEx */
    private static final String REGEX_ABSOLUTE_WINDOWS_PATH = REGEX_ABSOLUTE_WINDOWS_STANDARD_PATH + "|" + REGEX_ABSOLUTE_WINDOWS_ENV_PATH + "|"
            + REGEX_ABSOLUTE_WINDOWS_OPENSSH_PATH + "|" + REGEX_ABSOLUTE_WINDOWS_UNC_PATH;

    /** 4) FILESYSTEM */
    /** Unix and Windows */
    private static final String REGEX_ABSOLUTE_FILESYSTEM_PATH = REGEX_ABSOLUTE_UNIX_PATH + "|" + REGEX_ABSOLUTE_WINDOWS_PATH;
