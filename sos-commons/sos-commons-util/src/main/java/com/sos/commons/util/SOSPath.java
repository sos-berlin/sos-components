...
public class SOSPath {
    ...
    public static byte[] gzipFile(Path source) throws Exception {// TODO use commons.compress implementation
    ...
    public static byte[] gzipDirectory(Path source) throws Exception {
        if (source == null || !SOSPath.toFile(source).isDirectory()) {
     ...
     * @param targetDir
     * @throws IOException */
    public static void unpackGzip(Path source, Path targetDir) throws Exception {
        if (source == null || !SOSPath.toFile(source).isFile()) {
            throw new Exception(String.format("[%s]is not a file", source));
        }
        unpackGzip(Files.newInputStream(source), targetDir);
    }
     ...
     * @param targetDir
     * @throws IOException */
    public static void unpackGzip(byte[] source, Path targetDir) throws Exception {
        unpackGzip(new ByteArrayInputStream(source), targetDir);
    }
     ...
     * @param targetDir
     * @throws IOException */
    public static void unpackGzip(InputStream source, Path targetDir) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            SOSPath.unpackGzip(SOSPath.gzipDirectory(input), output);
