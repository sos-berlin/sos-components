...
public class YADEArguments extends ASOSArguments {
    ...
    public static final String ARG_PARALLELISM = "parallelism";
    ...
    // Source
    public static final String ARG_SOURCE_DIR = "source_dir";
    public static final String ARG_SOURCE_FILE_PATH = "source_file_path";
    public static final String ARG_SOURCE_FILE_SPEC = "source_file_spec";
    public static final String ARG_SOURCE_FILE_LIST = "source_file_list";
    public static final String ARG_SOURCE_EXCLUDED_DIRECTORIES = "source_excluded_directories";
    public static final String ARG_TARGET_DIR = "target_dir";
    ...
    public static final String ARG_SETTINGS_REPLACER_CASE_SENSITIVE = "settings_replacer_case_sensitive";
    public static final Boolean ARG_SETTINGS_REPLACER_CASE_SENSITIVE_DEFAULT = Boolean.valueOf(true);

    public static final String ARG_SETTINGS_REPLACER_KEEP_UNRESOLVED = "settings_replacer_keep_unresolved";
    public static final Boolean ARG_SETTINGS_REPLACER_KEEP_UNRESOLVED_DEFAULT = Boolean.valueOf(true);

    /** Other ---------------------------------------------------------------------------- */
    public final static String LABEL = "Transfer";

    /** - Fragment ------- */
    private SOSArgument<Path> settings = new SOSArgument<>(ARG_SETTINGS, false);
    private SOSArgument<String> profile = new SOSArgument<>(ARG_PROFILE, false);
     ...
     */
    private SOSArgument<Integer> parallelism = new SOSArgument<>(ARG_PARALLELISM, false, Integer.valueOf(1));
