...
@SequenceGenerator(
		name = YadeDBItemConstants.TABLE_YADE_FILES_SEQUENCE,
		sequenceName = YadeDBItemConstants.TABLE_YADE_FILES_SEQUENCE,
		allocationSize = 1)
public class DBItemYadeFiles implements Serializable {
    ...
    /** Primary key */
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO, generator = YadeDBItemConstants.TABLE_YADE_FILES_SEQUENCE)
