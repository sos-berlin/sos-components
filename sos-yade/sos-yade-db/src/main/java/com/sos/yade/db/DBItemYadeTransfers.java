...
@SequenceGenerator(
		name = YadeDBItemConstants.TABLE_YADE_TRANSFERS_SEQUENCE,
		sequenceName = YadeDBItemConstants.TABLE_YADE_TRANSFERS_SEQUENCE,
		allocationSize = 1)
public class DBItemYadeTransfers implements Serializable {
    ...
    /** Primary key */
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO, generator = YadeDBItemConstants.TABLE_YADE_TRANSFERS_SEQUENCE)
