...
public class JocInfoException extends RuntimeException {

	private static final long serialVersionUID = 1L;
	private JocError error;

	public JocInfoException() {
		super();
	}

	public JocInfoException(JocError error) {
		super(error.toString());
		this.error = error;
	}

	public JocInfoException(Throwable cause) {
		super(cause);
		this.error = new JocError();
		error.setMessage(cause.getMessage());
	}

	public JocInfoException(JocError error, Throwable cause) {
		super(error.toString(), cause);
		this.error = error;
	}

	public JocInfoException(JocError error, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
