 ...
 */
@Plugin(name = NotificationAppender.PLUGIN_NAME, category = Core.CATEGORY_NAME, elementType = Appender.ELEMENT_TYPE, printObject = true)
public final class NotificationAppender extends AbstractOutputStreamAppender<RollingFileManager> {

    public static final String PLUGIN_NAME = "NotificationAndRollingFile";
    ...
    public static class Builder<B extends Builder<B>> extends AbstractOutputStreamAppender.Builder<B>
            implements org.apache.logging.log4j.core.util.Builder<NotificationAppender> {
        ...
        @Override
        public NotificationAppender build() {
            if (!isValid()) {
                return null;
            }
            ...
            return new NotificationAppender(getName(), layout, getFilter(), manager, fileName, filePattern,
    ...
    private NotificationAppender(final String name, final Layout<? extends Serializable> layout, final Filter filter,
    ...
    public void append(final LogEvent event) {
        if (event.getLevel().isMoreSpecificThan(Level.WARN)) {
            EventBus.getInstance().post(logEventToNotification(event));
        }
    ...
    private NotificationLogEvent logEventToNotification(final LogEvent event) {
        ...
        return new NotificationLogEvent(event.getLevel().name(), category, event.getInstant().getEpochMillisecond(),
                event.getLoggerFqcn(), message.getFormattedMessage(), message.getThrowable());
    }
     ...
     */
    @Deprecated
    public static <B extends Builder<B>> NotificationAppender createAppender(
            // @formatter:off
        ...
        // @formatter:off
        return NotificationAppender.<B>newBuilder()
