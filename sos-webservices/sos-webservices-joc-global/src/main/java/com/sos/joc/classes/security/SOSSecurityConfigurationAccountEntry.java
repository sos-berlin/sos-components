...
public class SOSSecurityConfigurationAccountEntry {
    ...
    public SOSSecurityConfigurationAccountEntry(String entry, Profile.Section oldSection, SOSSecurityHashSettings sosSecurityHashSettings) {
        super();
    ...
    public SOSSecurityConfigurationAccountEntry(SecurityConfigurationAccount securityConfigurationAccount, Profile.Section oldSection,
            SOSSecurityHashSettings sosSecurityHashSettings) {
        super();
        this.oldSection = oldSection;
        this.sosSecurityHashSettings = sosSecurityHashSettings;
        this.securityConfigurationAccount = securityConfigurationAccount;
    }
    ...
    public String getIniWriteString() {
        String s = securityConfigurationAccount.getPassword();
        if (s == null) {
            s="";
        }
        ...
        s = s + ",";
        for (int i = 0; i < securityConfigurationAccount.getRoles().size(); i++) {
            s = s + securityConfigurationAccount.getRoles().get(i) + ",";
        }
