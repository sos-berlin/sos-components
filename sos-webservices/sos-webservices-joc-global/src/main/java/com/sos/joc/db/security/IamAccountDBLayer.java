...
public class IamAccountDBLayer {
	...
	private static final String DBItemIamAccount2Roles = com.sos.joc.db.authentication.DBItemIamAccount2Roles.class
			.getSimpleName();
	private static final String DBItemIamPermission = com.sos.joc.db.authentication.DBItemIamPermission.class
			.getSimpleName();
	...
	public List<DBItemIamAccount> getIamAccountList(IamAccountFilter filter, final int limit)
	...
	public List<DBItemIamAccount2Roles> getListOfRoles(Long accountId) throws SOSHibernateException {
		Query<DBItemIamAccount2Roles> query = sosHibernateSession
				.createQuery("from " + DBItemIamAccount2Roles + " where accountId=:accountId");
	...
	public List<DBItemIamRole> getListOfAllRoles(Long identityServiceId) throws SOSHibernateException {
		Query<DBItemIamRole> query = sosHibernateSession
				.createQuery("from " + DBItemIamRole + " where identityServiceId=:identityServiceId");
		query.setParameter("identityServiceId", identityServiceId);
	...
	public List<DBItemIamAccount2RoleWithName> getListOfRolesWithName(DBItemIamAccount dbitemIamAccount)
			throws SOSHibernateException {

		String q = "select u.roleId as roleId,u.accountId as accountId," + "r.roleName as roleName, '"
				+ dbitemIamAccount.getAccountName() + "' as accountName" + " from " + DBItemIamAccount2Roles + " u, "
				+ DBItemIamRole
	...
	public List<DBItemIamPermissionWithName> getListOfPermissionsWithName(Long identityServiceId)
			throws SOSHibernateException {
		...
		String q = "select p.controllerId as controllerId,p.roleId as roleId,"
				...
				+ "p.excluded as excluded,p.recursive as recursive,r.roleName as roleName" + " from "
				+ DBItemIamPermission + " p, " + DBItemIamRole
	...
	public List<DBItemIamPermissionWithName> getListOfRolesForAccountName(String accountName, Long identityServiceId)
			throws SOSHibernateException {

		String q = "select r.id as roleId," + "r.roleName as roleName" + " from " + DBItemIamAccount + " a, "
				+ DBItemIamAccount2Roles + " ar," + DBItemIamRole + " r" + " where a.accountName=:accountName"
	...
	public DBItemIamRole getRoleByName(String roleName, Long identityServiceId) throws SOSHibernateException {
		...
		Query<DBItemIamRole> query = sosHibernateSession.createQuery(
				"from " + DBItemIamRole + " where roleName=:roleName and identityServiceId=:identityServiceId");
	...
	public DBItemIamAccount2Roles getRoleAssignment(Long roleId, Long accountId) throws SOSHibernateException {
		...
		Query<DBItemIamAccount2Roles> query = sosHibernateSession
				.createQuery("from " + DBItemIamAccount2Roles + " where roleId=:roleId and accountId=:accountId");
	...
	public List<DBItemIamPermission> getListOfRolePermissions(Long roleId) throws SOSHibernateException {
		Query<DBItemIamPermission> query = sosHibernateSession
				.createQuery("from " + DBItemIamPermission + " where roleId=:roleId");
	...
	public List<DBItemIamPermission> getListOfPermissions(Long accountId) throws SOSHibernateException {
		Query<DBItemIamPermission> query = sosHibernateSession
				.createQuery("from " + DBItemIamPermission + " where accountId=:accountId");
	...
	private List<DBItemIamPermissionWithName> getListOfPermissionsFromRoles(Set<String> setOfRoles,
		...
		String q = "select  p.controllerId as controllerId,p.roleId as roleId,p.accountPermission as accountPermission,"
				+ "p.folderPermission as folderPermission,p.excluded as excluded,p.recursive as recursive,r.roleName as roleName "
				+ "from " + DBItemIamPermission + " p," + DBItemIamRole + " r" + " where " + getRoleListSql(setOfRoles)
	...
	public List<DBItemIamPermissionWithName> getListOfPermissionsFromRoleNames(Set<String> setOfRoles,
			Long identityServiceId) throws SOSHibernateException {
