...
public class SOSManageIdentityService {
    ...
    private SecurityConfiguration addDefaultIdentityService(SOSHibernateSession sosHibernateSession, Path iniFile) throws Exception {
        ...
        securityConfiguration = sosSecurityConfiguration.readConfigurationFromFilesystem(sosHibernateSession, iniFile);
    ...
    public static void download() {
        ...
        s.append("For importing shiro.ini configuration files please download the migration tool").append(System.lineSeparator());
        s.append("from: https://kb.sos-berlin.com/x/cIPTB").append(System.lineSeparator());
    ...
    public static void usage(Path defaultHibernateConf) {
        ...
        s.append(System.lineSeparator());
        s.append("            command               : hash or import").append(System.lineSeparator());
        s.append("            secret                : required for command hash").append(System.lineSeparator());
        s.append("            shiro_ini_file        : required for command import").append(System.lineSeparator());
        s.append("                                    path to the shiro.ini file to be imported.").append(System.lineSeparator());
        s.append("            hibernate_config_file : optional for command import, default: " + defaultHibernateConf.toAbsolutePath().toString())
                .append(System.lineSeparator());
        s.append("                                    path to the hibernate configuration file").append(System.lineSeparator());
        LOGGER.info(s.toString());
    }

    public static void main(String[] args) {

        boolean haveShiro = SOSSecurityConfiguration.haveShiro();
