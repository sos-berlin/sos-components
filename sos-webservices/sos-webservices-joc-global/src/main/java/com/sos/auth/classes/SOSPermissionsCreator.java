...
public class SOSPermissionsCreator {
    ...
    private JocPermissions getJocPermissions() {
        ...
        if (currentAccount != null && currentAccount.getCurrentSubject() != null) {
            ...
            admin.getCertificates().setView(haveRight(admin.getCertificates().getManageString()));
            admin.getControllers().setView(haveRight(admin.getControllers().getViewString()));
            admin.getControllers().setView(haveRight(admin.getControllers().getManageString()));
            admin.getSettings().setView(haveRight(admin.getSettings().getViewString()));
            admin.getSettings().setView(haveRight(admin.getSettings().getManageString()));
            admin.getCustomization().setView(haveRight(admin.getCustomization().getViewString()));
            admin.getCustomization().setView(haveRight(admin.getCustomization().getManageString()));
            admin.getCustomization().setView(haveRight(admin.getCustomization().getShareString()));
