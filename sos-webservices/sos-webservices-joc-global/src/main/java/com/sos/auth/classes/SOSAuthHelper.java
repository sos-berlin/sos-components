...
public class SOSAuthHelper {
	...
	public static SOSInitialPasswordSetting getInitialPasswordSettings()
		...
		try {
			...
			List<DBItemJocConfiguration> result = jocConfigurationDBLayer
					.getJocConfigurationList(jocConfigurationFilter, 1);
	...
	public static boolean checkCertificate(HttpServletRequest request, String account) {
		...
		if (request != null) {
			...
			try {
				...
				LOGGER.info("No client certificate found." + e.getMessage());
			}
		}
