            ...
            **/
            ...
            for (String controllerId : allControllers.keySet()) {
                ...
                if (toDeleteForRename != null && !toDeleteForRename.isEmpty()) {
                    ...
                    PublishUtils.updateRepoDelete(versionIdForDeleteRenamed, toDelete, controllerId, dbLayer, keyPair.getKeyAlgorithm())
                    .thenAccept(either -> {
            ...
            for (String controllerId : controllerIds) {
                ...
                if (depHistoryDBItemsToDeployDelete != null && !depHistoryDBItemsToDeployDelete.isEmpty()) {
                    ...
                    PublishUtils.updateRepoDelete(versionIdForDelete, toDelete, controllerId, dbLayer, 
