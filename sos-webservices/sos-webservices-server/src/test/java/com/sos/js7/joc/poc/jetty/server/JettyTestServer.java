...
import com.sos.js7.joc.poc.jetty.servlets.ReadCertificateTestServlet;
...
public class JettyTestServer {
    ...
    public void init(String keyStorePath, String keyStoreType, String keystorePw, String keystoreManagerPw, 
            String trustStorePath, String trustStoreType, String trustStorePw) throws Exception {
        server = new Server();
        ...
        servletHandler.addServletWithMapping(ReadCertificateTestServlet.class, "/status");
