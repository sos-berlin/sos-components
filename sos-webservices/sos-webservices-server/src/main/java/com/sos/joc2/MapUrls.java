...
public class MapUrls {
    ...
    public static final Map<String, String> centosdev_secondary_urlMapper = Collections.unmodifiableMap(new HashMap<String, String>() {
        ...
        {
            put("http://controller-2-0-primary:4444", "http://192.11.0.97:5444"); //centosdev_secondary.sos
            put("http://controller-2-0-backup:4444", "http://192.11.0.97:5544");
            put("http://controller-2-0-secondary:4444", "http://192.11.0.97:5544");
            put("http://controller-2-0-standalone:4444", "http://192.11.0.97:5344");
            put("https://controller-2-0-primary:4443", "http://192.11.0.97:5444");
            put("https://controller-2-0-backup:4443", "http://192.11.0.97:5544");
            put("https://controller-2-0-secondary:4443", "http://192.11.0.97:5544");
            put("https://controller-2-0-standalone:4443", "http://192.11.0.97:5344");
...
//            put("https://controller-2-0-standalone:4443", "https://centosdev_secondary.sos:5343");
    ...
    public static final Map<String, String> centostest_secondary_urlMapper = Collections.unmodifiableMap(new HashMap<String, String>() {

        private static final long serialVersionUID = 1L;

        {
            put("http://controller-2-0-primary:4444", "http://192.11.0.148:5444"); //centostest_secondary.sos
            put("http://controller-2-0-secondary:4444", "http://192.11.0.148:5544");
            put("http://controller-2-0-standalone:4444", "http://192.11.0.148:5344");
            put("https://controller-2-0-primary:4443", "http://192.11.0.148:5444");
            put("https://controller-2-0-secondary:4443", "http://192.11.0.148:5544");
            put("https://controller-2-0-standalone:4443", "http://192.11.0.148:5344");
        }
    });
