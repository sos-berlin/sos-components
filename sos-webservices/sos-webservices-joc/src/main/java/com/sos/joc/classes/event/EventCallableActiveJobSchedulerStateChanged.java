        ...
        for (JsonObject event : json.getJsonArray("eventSnapshots").getValuesAs(JsonObject.class)) {
            ...
            if (eventType.startsWith("Task")) {
                ...
                if (eventType.equals("VariablesCustomEvent")) {
                    ...
                    if (variables.containsKey("ReportingChanged")) {
                        switch (variables.getString("ReportingChanged", null)) {
                        case "order":
                            eventSnapshot.setEventType("ReportingChanged" + "Order");
                            eventSnapshot.setObjectType(JobSchedulerObjectType.ORDER);
                            break;
                        case "standalone":
                            eventSnapshot.setEventType("ReportingChanged" + "Job");
                            eventSnapshot.setObjectType(JobSchedulerObjectType.JOB);
                            break;
                        case "order_standalone":
                            ...
                            eventSnapshot2.setEventType("ReportingChanged" + "Job");
