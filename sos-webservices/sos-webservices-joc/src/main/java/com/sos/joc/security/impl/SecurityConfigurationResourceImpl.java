...
public class SecurityConfigurationResourceImpl extends JOCResourceImpl implements ISecurityConfigurationResource {
    ...
    public JOCDefaultResponse postAuthAcountsDelete(String accessToken, byte[] body) {
        try {
            ...
            initLogging(API_CALL_ACCOUNT_DELETE, Globals.objectMapper.writeValueAsBytes(securityConfigurationMasked), accessToken);
            JsonValidator.validate(body, SecurityConfiguration.class);
            SecurityConfiguration securityConfiguration = Globals.objectMapper.readValue(body, SecurityConfiguration.class);
            String identityServiceName = securityConfiguration.getIdentityServiceName();
            if (securityConfiguration.getRoles() != null) {
    ...
    public JOCDefaultResponse changePassword(String accessToken, byte[] body) {
        try {
            ...
            initLogging(API_CALL_CHANGE_PASSWORD, Globals.objectMapper.writeValueAsBytes(securityConfigurationMasked), accessToken);
    ...
    public JOCDefaultResponse forcePasswordChange(String accessToken, byte[] body) {
        try {
            ...
            initLogging(API_CALL_FORCE_PASSWORD_CHANGE, Globals.objectMapper.writeValueAsBytes(securityConfigurationMasked), accessToken);
            JsonValidator.validate(body, SecurityConfiguration.class);
            SecurityConfiguration securityConfiguration = Globals.objectMapper.readValue(body, SecurityConfiguration.class);
            String identityServiceName = securityConfiguration.getIdentityServiceName();
    ...
    public JOCDefaultResponse resetPassword(String accessToken, byte[] body) {
        try {
            ...
            initLogging(API_CALL_RESET_PASSWORD, Globals.objectMapper.writeValueAsBytes(securityConfigurationMasked), accessToken);
            JsonValidator.validate(body, SecurityConfiguration.class);
            SecurityConfiguration securityConfiguration = Globals.objectMapper.readValue(body, SecurityConfiguration.class);
            String identityServiceName = securityConfiguration.getIdentityServiceName();
    ...
    public JOCDefaultResponse postAuthAcountRename(String accessToken, byte[] body) {
        ...
        try {
            ...
            iamAccountDBLayer.renameAccount(dbItemIamIdentityService.getId(), accountRename.getAccountOldName(), accountRename.getAccountNewName());
    ...
    public JOCDefaultResponse postAuthRoleRename(String accessToken, byte[] body) {
        ...
        try {
            ...
            DBItemIamRole dbItemIamRole = iamAccountDBLayer.getRoleByName(roleRename.getRoleNewName(), dbItemIamIdentityService.getId());
            ...
            iamAccountDBLayer.renameRole(dbItemIamIdentityService.getId(), roleRename.getRoleOldName(), roleRename.getRoleNewName());
