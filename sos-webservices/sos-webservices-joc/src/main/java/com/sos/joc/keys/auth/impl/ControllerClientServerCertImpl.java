...
import com.sos.joc.keys.auth.resource.IControllerClientServerCert;
...
@Path("controller")
public class ControllerClientServerCertImpl extends JOCResourceImpl implements IControllerClientServerCert {

    private static String API_CALL = "./controller/certificate";

    @Override
    public JOCDefaultResponse postCreateControllerClientServerCert(String xAccessToken, byte[] filter) throws Exception {
