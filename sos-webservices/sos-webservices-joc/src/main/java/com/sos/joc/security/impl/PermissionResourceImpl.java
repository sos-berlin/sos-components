...
public class PermissionResourceImpl extends JOCResourceImpl implements IPermissionResource {
    ...
    public JOCDefaultResponse postPermissionRead(String accessToken, byte[] body) {
        ...
        try {
            ...
            if (dbItemIamPermission != null) {
                ...
                throw new JocObjectNotExistException("Object permission <" + permissionFilter.getPermissionPath() + "> not found");
            }
    ...
    public JOCDefaultResponse postPermissionsStore(String accessToken, byte[] body) {
        ...
        try {
            ...
            DBItemIamIdentityService dbItemIamIdentityService = SecurityHelper.getIdentityService(sosHibernateSession, permissions
                    .getIdentityServiceName());
            IamPermissionDBLayer iamPermissionDBLayer = new IamPermissionDBLayer(sosHibernateSession);
            DBItemIamRole dbItemIamRole = SecurityHelper.getRole(sosHibernateSession, dbItemIamIdentityService.getId(), permissions.getRoleName());
    ...
    public JOCDefaultResponse postPermissionRename(String accessToken, byte[] body) {
        ...
        try {
            ...
            sosHibernateSession.setAutoCommit(false);
            sosHibernateSession.beginTransaction();
            DBItemIamIdentityService dbItemIamIdentityService = SecurityHelper.getIdentityService(sosHibernateSession, permissionRename
                    .getIdentityServiceName());
            IamPermissionDBLayer iamPermissionDBLayer = new IamPermissionDBLayer(sosHibernateSession);
            DBItemIamRole dbItemIamRole = SecurityHelper.getRole(sosHibernateSession, dbItemIamIdentityService.getId(), permissionRename
                    .getRoleName());
            ...
            if (count == 0) {
                throw new JocObjectNotExistException("Object permission <" + permissionRename.getOldPermissionPath() + "> not found");
            }
    ...
    public JOCDefaultResponse postPermissionsDelete(String accessToken, byte[] body) {
        ...
        try {
            ...
            initLogging(API_CALL_PERMISSIONS_DELETE, Globals.objectMapper.writeValueAsBytes(permissionsFilter), accessToken);
            ...
            IamPermissionDBLayer iamPermissionDBLayer = new IamPermissionDBLayer(sosHibernateSession);
            DBItemIamIdentityService dbItemIamIdentityService = SecurityHelper.getIdentityService(sosHibernateSession, permissionsFilter
                    .getIdentityServiceName());
            DBItemIamRole dbItemIamRole = SecurityHelper.getRole(sosHibernateSession, dbItemIamIdentityService.getId(), permissionsFilter
                    .getRoleName());
