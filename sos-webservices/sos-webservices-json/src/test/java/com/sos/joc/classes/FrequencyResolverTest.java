...
public class FrequencyResolverTest {
    ...
    public void setUp() throws Exception {
        ...
        json += "}}";
        basedOn =
                "{\"includes\":{\"weekdays\":[{\"days\":[\"1\",\"2\",\"3\",\"4\",\"5\"]}]},\"path\":\"/test/test4\",\"id\":3,\"type\":\"WORKINGDAYSCALENDAR\",\"from\":\"2017-01-01\",\"to\":\"2018-12-31\"}";
        // LOGGER.info(json);
        ...
        calendarFilter.setCalendar(getCalendar(json));
    ...
    // java.util.Calendar cal = java.util.Calendar.getInstance();
    // cal.setTime(Date.from(Instant.parse("2017-06-22T00:00:00Z")));
    // int workingDay = fr.getUltimoWorkingDay(cal, fr.getLastDayOfMonth(java.util.Calendar.getInstance(), cal),
    // fr.getFirstDayOfMonth(java.util.Calendar.getInstance(), cal));
    // int expected = 7;
    // LOGGER.info(workingDay+"");
    ...
    public void reccuringRestrictions() throws Exception {
        String restriction =
                "{\"includes\":{\"repetitions\":[{\"from\":\"2017-11-06\", \"to\":\"2018-12-31\", \"repetition\":\"WEEKLY\", \"step\":2}]}}";
        Dates d = basedOnFr.resolveRestrictions(getCalendar(basedOn), getCalendar(restriction), "2017-11-14", null);
    ...
    public void reccuringRestrictions2() throws Exception {
        ...
        Dates d = basedOnFr.resolveRestrictions(getCalendar(basedOn), getCalendar(restriction), null, null);
        LOGGER.info(d.getDates().toString());
    }
    ...
    private Calendar getCalendar(String json) throws JsonParseException, JsonMappingException, IOException {
        return new ObjectMapper().readValue(json, Calendar.class);
    }
