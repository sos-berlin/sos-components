    ...
    extends com.sos.inventory.model.fileordersource.FileOrderSource
{
     ...
     */
    public FileOrderSource(String path, Date versionDate, SyncState state, Boolean valid, Boolean deployed, String workflowName, String agentName, String directoryExpr, String directory, String pattern, String timeZone, Long delay, String title, String documentationName) {
