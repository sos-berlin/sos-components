...
public class OrderNotificationAcknowledgeFilter {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OrderNotificationAcknowledgeFilter) == false) {
            return false;
        }
        OrderNotificationAcknowledgeFilter rhs = ((OrderNotificationAcknowledgeFilter) other);
