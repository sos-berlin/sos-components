...
public class ShowViewProperties {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("dashboard", dashboard).append("dailyPlan", dailyPlan).append("workflows", workflows).append("orders", orders).append("jobStreams", jobStreams).append("fileTransfers", fileTransfers).append("resources", resources).append("history", history).append("auditLog", auditLog).append("conditions", conditions).append("configuration", configuration).append("monitor", monitor).append("report", report).toString();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(jobStreams).append(dailyPlan).append(auditLog).append(configuration).append(resources).append(orders).append(fileTransfers).append(workflows).append(history).append(conditions).append(dashboard).append(monitor).append(report).toHashCode();
    }
