...
package com.sos.joc.model.inventory.report;
    ...
    extends ConfigurationObject
{
     ...
     */
    @JsonProperty("configuration")
    public Report getConfiguration() {
     ...
     */
    @JsonProperty("configuration")
    public void setConfiguration(Report configuration) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReportEdit) == false) {
            return false;
        }
        ReportEdit rhs = ((ReportEdit) other);
