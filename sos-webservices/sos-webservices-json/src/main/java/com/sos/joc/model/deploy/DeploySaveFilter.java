...
/**
 * Deploy filter for saving JS Objects to the database
 * <p>
 * 
 * 
 */
...
public class DeploySaveFilter {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DeploySaveFilter) == false) {
            return false;
        }
        DeploySaveFilter rhs = ((DeploySaveFilter) other);
