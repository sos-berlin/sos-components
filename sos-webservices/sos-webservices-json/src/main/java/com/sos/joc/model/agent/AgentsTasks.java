...
public class AgentsTasks {
    ...
    @JsonProperty("agents")
    private List<AgentTasks> agents = new ArrayList<AgentTasks>();
    ...
    @JsonProperty("agents")
    public List<AgentTasks> getAgents() {
        return agents;
    }

    @JsonProperty("agents")
    public void setAgents(List<AgentTasks> agents) {
        this.agents = agents;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AgentsTasks) == false) {
            return false;
        }
        AgentsTasks rhs = ((AgentsTasks) other);
