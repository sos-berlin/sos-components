...
public class ModifyOrder {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("orderId", orderId).append("workflow", workflow).append("position", position).append("arguments", arguments).toString();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(arguments).append(position).append(workflow).append(orderId).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(arguments, rhs.arguments).append(position, rhs.position).append(workflow, rhs.workflow).append(orderId, rhs.orderId).isEquals();
    }
