...
public class Fido2RemoveDevices {
     ...
     * @param accountName
     */
    public Fido2RemoveDevices(String identityServiceName, String accountName, AuditParams auditLog) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Fido2RemoveDevices) == false) {
            return false;
        }
        Fido2RemoveDevices rhs = ((Fido2RemoveDevices) other);
