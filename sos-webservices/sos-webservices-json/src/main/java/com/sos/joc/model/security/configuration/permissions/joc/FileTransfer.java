...
public class FileTransfer {
     ...
     */
    @JsonProperty("view")
    @JsonPropertyDescription("show history, configuration tab")
    private Boolean view = false;
    @JsonProperty("manage")
    private Boolean manage = false;

    public FileTransfer(String prefix) {
        this.prefix = JocPermissions.getPermissionString(prefix, "filetransfer");
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FileTransfer) == false) {
            return false;
        }
