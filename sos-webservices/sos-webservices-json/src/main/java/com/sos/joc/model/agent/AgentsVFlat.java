...
public class AgentsVFlat {
    ...
    @JsonProperty("agents")
    private List<AgentStateV> agents = new ArrayList<AgentStateV>();
    ...
    @JsonProperty("agents")
    public List<AgentStateV> getAgents() {
        return agents;
    }

    @JsonProperty("agents")
    public void setAgents(List<AgentStateV> agents) {
        this.agents = agents;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AgentsVFlat) == false) {
            return false;
        }
        AgentsVFlat rhs = ((AgentsVFlat) other);
