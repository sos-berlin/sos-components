...
/**
 * Descriptor Folder Edit configuration
 * <p>
 * 
 * 
 */
...
public class DescriptorFolderEdit
    extends ConfigurationObject
{
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DescriptorFolderEdit) == false) {
            return false;
        }
        DescriptorFolderEdit rhs = ((DescriptorFolderEdit) other);
