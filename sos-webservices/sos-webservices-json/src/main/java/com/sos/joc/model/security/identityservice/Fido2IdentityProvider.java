...
public class Fido2IdentityProvider {
     ...
     */
    public Fido2IdentityProvider(String identityServiceName, String iamFido2RpName, Fido2Userverification iamFido2UserVerification, Integer iamFido2Timeout, Fido2Attestation iamFido2Attestation, Fido2Transports iamFido2Transports, String iamIconUrl) {
        super();
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(iamFido2Attestation).append(identityServiceName).append(iamFido2RpName).append(iamIconUrl).append(iamFido2Timeout).append(iamFido2Transports).append(iamFido2UserVerification).toHashCode();
    }
