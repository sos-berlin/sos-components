...
package com.sos.joc.model.dailyplan.generate.common;
...
public class GenerateSelector {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GenerateSelector) == false) {
            return false;
        }
        GenerateSelector rhs = ((GenerateSelector) other);
