...
/**
 * daily plan submissions request
 * <p>
 * 
 * 
 */
...
public class SubmissionsRequest {
     ...
     */
    @JsonProperty("filter")
    private SubmissionsRequestFilter filter;
     ...
     */
    @JsonProperty("filter")
    public SubmissionsRequestFilter getFilter() {
        return filter;
    }
     ...
     */
    @JsonProperty("filter")
    public void setFilter(SubmissionsRequestFilter filter) {
        this.filter = filter;
    }
