...
public class FidoRegistration {
     ...
     * @param jwk
     */
    public FidoRegistration(String identityServiceName, String accountName, String email, String origin, String publicKey, String jwk, String credentialId, String clientDataJSON, Boolean deferred, Boolean confirmed, AuditParams auditLog) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FidoRegistration) == false) {
            return false;
        }
        FidoRegistration rhs = ((FidoRegistration) other);
