...
package com.sos.joc.model.xmleditor.remove.all;
...
public class RemoveAllAnswer {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RemoveAllAnswer) == false) {
            return false;
        }
        RemoveAllAnswer rhs = ((RemoveAllAnswer) other);
