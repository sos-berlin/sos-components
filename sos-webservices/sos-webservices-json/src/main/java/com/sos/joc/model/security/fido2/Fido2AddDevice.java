...
public class Fido2AddDevice {
     ...
     * @param jwk
     */
    public Fido2AddDevice(String identityServiceName, String accountName, String publicKey, String jwk, String credentialId, String origin, AuditParams auditLog) {
        super();
