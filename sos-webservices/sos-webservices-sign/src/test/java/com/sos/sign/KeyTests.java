...
public class KeyTests {
    ...
    @Test
    public void test2SignObjectWithPaths() {
    ...
    @Test
    public void test3SignObjectWithInputStreams() {
	...
	@Test
	public void test4VerifySignatureString() {
	...
	@Test
	public void test5VerifySignatureFile() {
	...
	@Test
	public void test6VerifySignatureInputStream() {
	...
	@Test
	public void test7SignAndVerifyStrings () {
		String passphrase = null;
		String signature = null;
    ...
    @Test
    public void test8aSignAndVerifyPathsWithString () {
        Path privateKeyPath = Paths.get(PRIVATEKEY_PATH);
        Path originalPath = Paths.get(ORIGINAL_PATH);
        Path publicKeyPath = Paths.get(PUBLICKEY_PATH);
        String passphrase = null;
    ...
    @Test
    public void test8bSignAndVerifyPathsWithInputStream () {
        Path privateKeyPath = Paths.get(PRIVATEKEY_PATH);
        Path originalPath = Paths.get(ORIGINAL_PATH);
        Path publicKeyPath = Paths.get(PUBLICKEY_PATH);
        String passphrase = null;
    ...
    @Test
    public void test9SignAndVerifyInputStreams () {
        InputStream privateKeyInputStream = getClass().getResourceAsStream(PRIVATEKEY_RESOURCE_PATH);
        InputStream originalInputStream = getClass().getResourceAsStream(ORIGINAL_RESOURCE_PATH);
        InputStream publicKeyInputStream = getClass().getResourceAsStream(PUBLICKEY_RESOURCE_PATH);
        String passphrase = null;
