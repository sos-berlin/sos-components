...
public class TestSOSServicePermissionShiro {
    ...
    public void testHasRole() throws SessionNotExistException {
        SOSShiroCurrentUserAnswer sosShiroCurrentUserAnswer = GlobalsTest.sosServicePermissionShiro.hasRole(accessToken, GlobalsTest.SHIRO_ROLE);
    ...
    private static boolean isPermitted(String permission) {
        return GlobalsTest.sosServicePermissionShiro.isPermitted(accessToken, permission).isPermitted();
    }
