...
import com.sos.webservices.order.rest.order.classes.OrderHelper;
import com.sos.webservices.order.rest.order.resource.IRemoveOrderResource;
...
public class RemoveOrdersImpl extends JOCResourceImpl implements IRemoveOrderResource {
    ...
    private void removeOrders(PlanFilter planFilter) throws JocConfigurationException, DBConnectionRefusedException,
    ...
    @Override
    public JOCDefaultResponse postRemoveOrders(String xAccessToken, PlanFilter planFilter) throws JocException {
